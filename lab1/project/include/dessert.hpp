...
//                                 //
/*---------------------------------*/
// github repo: https://github.com/r-lyeh-archived/dessert
    ...
    public:
        static bool queue( const function<void()> &fn, const string &text ) {
            ...
            static struct install : public deque<function<void()>> {
                ...
                ~install() {
                    for( auto &fn : *this ) fn();
                    string ss, run = to_str( get(PASSED)+get(FAILED) ), res = get(FAILED) ? "[\033[1;31mFAIL\033[0m]  " : "[ \033[1;32mOK\033[0m ]  ";
        ...
        ~suite() {
            ...
            string res[] = { "[\033[1;31mFAIL\033[0m]", "[ \033[1;32mOK\033[0m ]", "  ", " *", "        ", "" }, *bp = &res[2], *tab = &res[4];
